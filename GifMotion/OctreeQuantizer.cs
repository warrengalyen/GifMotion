...
namespace GifMotion
{
    ...
    public class OctreeQuantizer : Quantizer 
    {
        ...
        private class Octree
        {
            ...
            /// Construct the octree
            /// </summary>
            /// <param name="maxColorsBits">The maximum number of significant bits in the image</param>
            public Octree(int maxColorsBits)
            {
                _maxColorBits = maxColorsBits;
                Leaves = 0;
            ...
            private void Reduce()
            {
                ...
                // And just iun case we've reduce the last color to be added, and the next color to
                // be added is the same, invalid the previousNode...
                _previousNode = null;
            }
