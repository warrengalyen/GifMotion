    ...
    public class PaletteQuantizer : Quantizer 
    {
        ...
        protected override byte QuantizePixel(Color32 pixel)
        {
            ...
            else
            {
                ...
                if (0 == pixel.Alpha)
                {
                    // Transparent. Lookup the first color with an value of 0
                ...
                else
                {
                    ...
                    for (int index = 0; index < Colors.Length; index++)
                    {
                        ...
                        if (distance < leastDistance)
                        {
                            ...
                            // exit the loop if it's an exact match
                            if (0 == distance)
                                break;
                        }
                    }
                ...
                // Now that we have the color, add it into the hashtable for next time
        ...
        /// </summary>
        /// <param name="palette">The old palette, this is overwritten</param>
