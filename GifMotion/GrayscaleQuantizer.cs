...
namespace GifMotion
{
    public class GrayscaleQuantizer : PaletteQuantizer
    {
        ...
        public GrayscaleQuantizer() : base(new ArrayList())
        {
            ...
            // Initialize new color table with entries that are determined
            // by some optional palette-finding algorithm; for demonstration
            ...
            for (uint i = 0; i < nColors; i++)
            {
                ...
                // Create a grayscale for demonstration purposes.
